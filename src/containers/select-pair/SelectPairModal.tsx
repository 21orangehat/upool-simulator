          ...
          <>
            ...
            <Container>
              ...
              <SelectNetworkContainer>
                ...
                >
                  {!selectedNetwork && <span>Selecione uma rede</span>}
              ...
              <SelectPairContainer>
                ...
                >
                  {!selectedTokens[0] && <span>Token A</span>}
                  {selectedTokens[0] && (
                    <span>
                      <img
                ...
                >
                  {!selectedTokens[1] && <span>Token B</span>}
                  {selectedTokens[1] && (
                    <span>
                      <img
              ...
              <Heading>Selecione a Taxa</Heading>
              <FeeTiersContainer>
                <Tier
              ...
              >
                ...
                {!isSubmitLoading && <span>Simular</span>}
              </PrimaryBlockButton>
            </Container>
          </>
        )}
